...
export default function AddAccountButton({
  ...
  const label = mode === 'brand' ? 'Add Brand' : 'Add Social Profile'
  ...
  const handleBrandSubmit = async (formData: FormData) => {
    setError(null)
      ...
      <Modal isOpen={isOpen} onClose={handleClose}>
        {mode === 'brand' ? (
          <>
            ...
            <form action={handleBrandSubmit} className="flex flex-col gap-6">
              <Input
                name="brandName"
                label="Brand Name"
              ...
              <div className="w-full relative">
                ...
                <div className="relative group">
                  <input
                    ...
                    style={{ paddingRight: accountsWithTokens.length > 0 ? '48px' : '18px' }}
                  />
