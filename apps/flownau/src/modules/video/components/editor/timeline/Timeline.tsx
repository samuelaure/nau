...
export function Timeline() {
    ...
    // Resize Logic
    const handleResizeMouseDown = (e: MouseEvent<HTMLDivElement>, id: string, startFrame: number, duration: number, handle: 'start' | 'end') => {
        e.stopPropagation();
        setResizingId(id);
        ...
        const handleWindowMouseUp = () => {
            ...
            // Commit Resize
                ...
                if (resizeHandle === 'start') {
                    ...
                    const newDuration = originalDuration - (newStart - originalStartFrame);
                    updateElement(resizingId, { startFrame: newStart, durationInFrames: newDuration });
                } else {
    ...
    }, [draggingId, resizingId, resizeHandle, dragStartX, originalStartFrame, originalDuration, dragFrameDelta, template.durationInFrames, updateElement]);
                            ...
                            <div key={el.id} className="h-8 my-2 relative flex items-center group">
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        onMouseDown={(e) => handleResizeMouseDown(e, el.id, el.startFrame, el.durationInFrames, 'start')}
                                    />
                                    <div
                                        ...
                                        onMouseDown={(e) => handleResizeMouseDown(e, el.id, el.startFrame, el.durationInFrames, 'end')}
                                    />
                                </div>
                            </div>
                        );
