...
const SlideComponent: React.FC<{ slide: CarouselSlide; theme: CarouselTheme }> = ({ slide, theme }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', bottom: 40, width: '100%', display: 'flex', justifyContent: 'center' }}>
        <p style={{ fontFamily: `"${theme.fontFamily}", sans-serif`, color: '#9ca3af', fontWeight: 600, fontSize: '24px' }}>
          desliza ➔
        </p>
      </div>
    </AbsoluteFill>
