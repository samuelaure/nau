...
const IDEAS = [
  {
    idea: 'La conexión entre padres e hijos se fortalece cuando los niños aprenden en libertad y confianza.',
    template: 'Head Talk — Hook First',
  },
  {
    idea: 'El mayor dolor de los padres de homeschool es sentir que van contra la corriente, solos.',
    template: 'Head Talk — Pain of Niche',
  },
  {
    idea: 'Cuando dejé de obligar a mi hijo a estudiar, algo inesperado ocurrió: empezó a querer aprender.',
    template: 'Head Talk — Relatable Story',
  },
]
